...
class GeneralConstant {
  ...
  String row = 'ردیف';
  String successCopy = 'متن با موفقیت کپی شد';
  String beforeCopy = 'کپی';
  String cancelText = 'لغو';
  String ascendingSort = 'مرتب‌سازی صعودی';
  String descendingSort = 'مرتب‌سازی نزولی';
  ...
  String noDataFound = 'داده‌ای یافت نشد';
}
...
const Color kLightBlueColor = Color(0xFF5886FF);
const Color kDarktBlueColor = Color.fromARGB(255, 13, 71, 161);
const Color kLightGreyColor = Color(0xfff7f8fd);
const Color kDarkGreyColor = Color.fromARGB(248, 106, 106, 106);
const Color kCardColor = Colors.white;
Color kCardColor1 = Colors.white;
const Color kLightGreenColor = Color.fromARGB(255, 86, 167, 127);
const Color kHoverColor = Colors.amber;
const Color kFocusColor = Colors.transparent;
const Color kswitchColor = Color(0Xff3CABBD);
const Color kSuccessColorAppButton = Color(0xFF08A158);
double kDefaultPadding = Get.width / 92;
const Color kCyanColor = Color(0Xff3CABBD);
const Color kNextButtonColor = kPrimaryColor;
const Color kPrevoiusButtonColor = kSecondaryColor;
const Color kSubmitButtonColor = kPrimaryColor;
const Color kCancelButtonColor = kDarkGreyColor;
const Color kNewButtonColor = kPrimaryColor;
const Color kCard1Color = Color.fromARGB(255, 107, 99, 205);
const Color kEditButtonColor = Color.fromARGB(255, 15, 147, 168);
const Color kDeleteButtonColor = Color.fromARGB(255, 248, 116, 116);
const Color kSuccessapicolor = Color(0Xff3CABBD);
const Color kFailapicolor = Color.fromARGB(255, 248, 116, 116);
...
const Color scaffoldBackgroundColor = Color(0xFF464667);
