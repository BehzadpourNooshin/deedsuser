...
import 'package:deedsuser/views/widgets/mytextformfieldautomatewidget.dart';
...
import 'package:deedsuser/views/widgets/mytextformfieldepochtimeesbtime.dart';
import 'package:deedsuser/views/widgets/mytextformfieldepochtime.dart';
              ...
              child: ListView(
                  ...
                  children: [
                    ...
                    if (fullReportController.selectedreport.isEmpty)
                        ...
                        title: SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              ...
                              resultSearchController.headerForProperties
                                  .clear();
                              ...
                              resultSearchController.linechartdatasource
                                  .clear();
                              resultSearchController.piechartdatasource.clear();
                              resultSearchController.linechartdatasource
                                  .clear();
                              ...
                              optionSearchController.searchForProperties
                                  .clear();
                      ...
                      for (var filterReport in fullReportController
                          .selectedreport[0].filters) ...[
                        ...
                        if (filterReport.formItemInputType == 'TextBox' &&
                            filterReport.formItemType == 'Automation') ...[
                          ListTile(
                            title: MyTextFormFieldAutomate(
                                enable: filterReport.formItemValidationType ==
                                        'uuid'
                                    ? false
                                    : true,
                        ...
                        if (filterReport.formItemInputType == 'Range' &&
                          ...
                          ListTile(
                              title:
                                  MyMultiTypeTextFormFilterFieldDateTimeTimeSTamp(
                                      validation:
                                          filterReport.formItemValidationType,
                                      labelTitle:
                                          filterReport.formItemDisplayTitle,
                                      hintTitle:
                                          filterReport.formItemInputTypeHint,
                                      errorTitle:
                                          filterReport.formItemValidationType,
                        ...
                        if (filterReport.formItemInputType == 'Range' &&
                            filterReport.formItemType == 'DateTime' &&
                            filterReport.formItemValidationType
                                .contains('esbdatetime')) ...[
                          ListTile(
                              title:
                                  MyMultiTypeTextFormFilterFieldDateTimeESBDateTime(
                                      validation:
                                          filterReport.formItemValidationType,
                                      labelTitle:
                                          filterReport.formItemDisplayTitle,
                        ...
                        if (filterReport.formItemInputType == 'DropDown') ...[
                          ListTile(
                            title: MySearchableDropDown(
                              ...
                              lookupname: filterReport.lookupName,
                              hintTitle: filterReport.formItemInputTypeHint,
