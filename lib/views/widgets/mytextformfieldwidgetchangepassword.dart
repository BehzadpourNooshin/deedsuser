...
class MyTextFormFieldChangePassword extends StatelessWidget {
  ...
  const MyTextFormFieldChangePassword(
      {super.key,
  ...
  Widget build(BuildContext context) {
    AccountsController passwordController = Get.put(AccountsController());
    ...
    return Obx(() => TextFormField(
        ...
        minLines: 1,
        onChanged: (value) {
          passwordController.currentpassowrdobs.value = value;
        ...
        decoration: InputDecoration(
          ...
          suffixIcon: Padding(
            ...
            child: IconButton(
              ...
              onPressed: () {
                passwordController.currentpassowrdobs.value = '';
                passwordController.currentPassword.text = '';
                passwordController.update();
                passwordController.validationPassword();
              },
            ),
