...
class MyTextFormFieldNewPassword extends StatelessWidget {
  ...
  const MyTextFormFieldNewPassword(
      {super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() => TextFormField(
        ...
        minLines: 1,
        onChanged: (value) {
          passwordController.newPassowrdobs.value = value;
        ...
        decoration: InputDecoration(
          ...
          suffixIcon: Padding(
            ...
            child: IconButton(
              ...
              onPressed: () {
                passwordController.newPassword.text = '';
                passwordController.newPassowrdobs.value = '';
                passwordController.update();
                passwordController.validationPassword();
              },
            ),
