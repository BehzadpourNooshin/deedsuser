...
class MyTextFormFieldPasswordConfrim extends StatelessWidget {
  ...
  const MyTextFormFieldPasswordConfrim(
      {super.key,
  ...
  Widget build(BuildContext context) {
    final AccountsController passwordController = Get.put(AccountsController());
    ...
    return Obx(() => TextFormField(
        ...
        minLines: 1,
        onChanged: (value) {
          passwordController.confirmNewPasswordobs.value = value;
          passwordController.validatePassword();
          passwordController.validationPassword();
        ...
        decoration: InputDecoration(
          ...
          suffixIcon: Padding(
            ...
            child: IconButton(
              ...
              onPressed: () {
                passwordController.confirmNewPassword.text = '';
                passwordController.confirmNewPasswordobs.value = '';
                passwordController.update();
                passwordController.validationPassword();
              },
            ),
