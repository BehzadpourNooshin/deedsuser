import 'package:deedsuser/models/chartreport_model.dart';
import 'package:get/get.dart';

class ChartReportController extends GetxController {
  RxList<ChartReportModel> chartreports = <ChartReportModel>[].obs;
  bool isAdd = false;
  int index = 0;
